...
class File extends Field {
	...
	public function processCreate ( ) {
		...
		if ( !is_uploaded_file ( $file['tmp_name'] ) ) throw new Exception ( $this->getUploadErrorMessage ( $file['error'] ) );

pr("target folder: " .$this->_targetFolder);
		$newFileName = $this->getNewFileName ( $file['name'] , $this->_targetFolder ) ;

pr($file['tmp_name']);

		pr($this->getView()->getName());
